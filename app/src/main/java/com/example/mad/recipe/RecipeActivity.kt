package com.example.mad.recipe
...
import com.example.mad.category.CategoryViewModel
...
class RecipeActivity : ComponentActivity(){
            ...
            setContent {
                MADTheme {
                    ...
                    Surface(
                        ...
                        //Greeting2("Android")
                        RecipeScreen(onCategoryItemClicked = {}, onGetStartedClicked = {
    ...
    @Composable
    fun RecipeScreen(onGetStartedClicked:()->Unit = {}, onCategoryItemClicked: () -> Unit) {
